...
class DummyRiskManager:
    ...
    def configure_gate(self, *, cooldown_duration_ms: int, cooldown_trigger_losses: int, cooldown_drawdown_pct: float):
        self.configured = {
...
def test_run_applies_risk_gate_config(monkeypatch, tmp_path):
    ...
    assert "Risk gate: losses=5, cooldown_ms=60000, drawdown_pct=80.0" in result.output
